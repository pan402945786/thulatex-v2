...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
        ...
        \ENSURE  
        \FOR {$i \to total\_classes.length - 1$}
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
        ...
        \FOR {$epoch \to EPOCH$}
            ...
            \ENDFOR
            \IF {$(loss\_sum \div dataLength < T\_threshold) and (T\_converge == null)$}
